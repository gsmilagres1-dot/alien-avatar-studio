...
export const SHIP_STATS: Record<string, ShipStats> = {
  ...
  "unilander-77": { category: "micro", fuelMult: 1.38, o2Mult: 1.28, cargoMult: 0.55, speedMult: 1.28, blurb: "Moto voadora, autonomia enorme", noseAngleDeg:0, flipX , flipX: true },
